...
const addListenerTombolGerak = () => {
    const tombolNakalEl = document.querySelector('#tombol_nakals');

    tombolNakalEl.addEventListener('mouseover', () => {
    ...
    tombolNakalEl.addEventListener('click', () => {
        tombolNakalEl.innerText = 'Selamat Anda Berhasil Klik Saya :D';
